...
- [ ] Add protocol artifact requirements for FIX work: dictionaries, counterparty rules of engagement, credentials, endpoint, cert/TLS mode, sequence reset policy.
