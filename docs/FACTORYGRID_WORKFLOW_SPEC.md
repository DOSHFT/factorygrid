...
- vLLM model API, diagnostics only: `http://localhost:18000/v1`
- LiteLLM gateway, agent-facing: `http://localhost:4000/v1`
...
- Daily context: 8k
- Daily parallel sequences: 1
- Quantization: AWQ Marlin

Qwen3-Coder and red/blue alternatives are profile-switched vLLM candidates. They must not run as separate model servers.
